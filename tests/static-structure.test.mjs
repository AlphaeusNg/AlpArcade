...
const reaction = read("js/games/reaction.js");
assert(
  reaction.includes("function setText(el, value)")
...
assert(
  read("js/games/breaker.js").includes('id: "wide"')
    ...
    && read("js/games/breaker.js").includes("const LEVEL_GROWTH = 1.5")
    && read("js/games/breaker.js").includes("const BASE_COLS = 8")
    && read("js/games/breaker.js").includes("function layoutForLevel")
    ...
    && read("js/games/breaker.js").includes("const WIDE_END_GAP = 12")
    && read("js/games/breaker.js").includes("const WIDE_MAX_STACKS = 14")
